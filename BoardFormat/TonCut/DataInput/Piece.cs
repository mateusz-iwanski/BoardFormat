...
namespace TonCut
{
    ...
    /// </summary>
    public class Piece : DataGroupInput, ISemiFinished, IDataGroupRoot
    {
        /// <summary>
        /// Unique piece id.
        /// </summary>
        ...
        /// <summary>
        /// The net length of the piece. For 1D shapes, it is always the total length, including slants.
        /// </summary>
        ...
        /// <summary>
        /// Type of the shape of the piece. Allowed values: none, rectangle, linear. 
        /// Allowed values:
        ///     - none
        ...
        /// <summary>
        /// Priority of the piece. Allowed values: normal, high, critical.
        /// Allowed values
        ///     - normal
        ///         The piece is handled normally.
        ///     - high
        ///         The piece has 5x higher value than normal ones.
        ///     - critical
        ///         The piece has 10x higher value than normal ones.
        /// </summary>
        ...
        /// Unique piece id.
        /// </summary>
        /// <param name="id">The unique piece id.</param>
        /// <param name="materialId">The ID of the material group from which this piece will be cut.</param>
        /// <param name="identifier">The user defined identifier of the piece. It must be Code128 barcode compatible.</param>
        /// <param name="description">Description of the piece.</param>
        /// <param name="length">The net length of the piece. For 1D shapes, it is always the total length, including slants.</param>
        /// <param name="width">The net width of the piece.</param>
        /// <param name="shapeType">Type of the shape of the piece. Allowed values: none, rectangle, linear.</param>
        /// <param name="quantity">Specifies quantity of pieces.</param>
        /// <param name="structure">Specifies acceptable structures of the piece. Allowed values: none, byLength, byWidth.</param>
        /// <param name="priority">Priority of the piece. Allowed values: normal, high, critical.</param>
        /// <param name="surplus">Specifies the surplus, meaning the amount by which the piece size will be enlarged on all sides.</param>
        /// <param name="margin">Specifies the Margin, which is the amount by which the piece size will be reduced on all sides.</param>        
